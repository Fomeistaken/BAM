                  ...
                  <div className="h-48 md:h-56 lg:h-64 relative">
                    ...
                    <div className="absolute inset-0 p-4 flex flex-col justify-end">
                      ...
                      <p className="text-lg text-white">
                        Discover courses in various subjects and expand your
                        knowledge.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                  <div className="h-48 md:h-56 lg:h-64 relative">
                    ...
                    <div className="absolute inset-0 p-4 flex flex-col justify-end">
                      ...
                      <p className="text-lg text-white">
                        Upgrade your skills and advance your career with our
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                  <div className="h-48 md:h-56 lg:h-64 relative">
                    ...
                    <div className="absolute inset-0 p-4 flex flex-col justify-end">
                      ...
                      <p className="text-lg text-white">
                        Take courses at your own pace and on your own schedule,
                        without deadlines or due dates.
                      </p>
                    </div>
                  </div>
                </div>
